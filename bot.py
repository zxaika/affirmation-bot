...
# Резервные аффирмашки (без запрещённых тем)
FALLBACK_AFFIRMATIONS = [
    ...
    "Моя улыбка разряжает любую конфликтную ситуацию\n\n#дипломатия",
    "Я открываю новые слои метаиронии каждый день\n\n#метаирония"
]
    ...
    try:
        ...
        response = groq_client.chat.completions.create(
            messages=[
                ...
                {"role": "user", "content": "напиши новую аффирмашку дня. нельзя про пиццу, еду, носки, лягушек."}
            ],
        ...
        forbidden_words = ["пицц", "еда", "съесть", "лягуш", "носк", "стройн", "вес", "диет"]
        for word in forbidden_words:
            if word in post.lower():
                print(f"⚠️ Обнаружена запрещённая тема, беру из резерва")
...
async def main():
    ...
    print("🚫 Запрещены: пицца, еда, носки, лягушки, стройность, диеты")
